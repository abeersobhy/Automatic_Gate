...
#define TIM2  			((Timerx_typedef*)TIMER2_BASE)
#define TIM3  			((Timerx_typedef*)TIMER3_BASE)
#define TIM4  			((Timerx_typedef*)TIMER4_BASE)
...
#define TIM2_IRQ_ER			28
#define TIM3_IRQ_ER			29
#define TIM4_IRQ_ER			30
...
#define NVIC_TIM2_GI_Enable			(NVIC_ISER0 |= (1 << 28))
#define NVIC_TIM3_GI_Enable			(NVIC_ISER0 |= (1 << 29))
#define NVIC_TIM4_GI_Enable			(NVIC_ISER0 |= (1 << 30))

#define NVIC_TIM2_GI_Disable		(NVIC_ICER0 |= (1 << 28))
#define NVIC_TIM3_GI_Disable		(NVIC_ICER0 |= (1 << 29))
#define NVIC_TIM4_GI_Disable		(NVIC_ICER0 |= (1 << 30))
